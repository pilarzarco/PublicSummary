...
Looking ahead, there is potential to further improve the sampling techniques or incorporate adaptive methods like Bayesian Optimisation to boost the emulator’s performance even more.
""")
